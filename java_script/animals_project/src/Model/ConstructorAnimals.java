...
public class ConstructorAnimals {
    ...
    public ConstructorAnimals (int id, String name, String type, ArrayList commands, String date) {
        setId(id);
        setName(name);
        setType(type);
    ...
    public ConstructorAnimals (int id, String name, String type, String commands, String date) {
        setId(id);
        setName(name);
        setType(type);
        setCommands(commands);
    ...
    public ConstructorAnimals (String name, String type, ArrayList commands, String date) {
        setName(name);
        setType(type);
        setCommands(commands);
        setDate_of_birth(date);
    ...
    public ConstructorAnimals (String name, String type, String commands, String date) {
        setName(name);
        setType(type);
        setCommands(commands);
        setDate_of_birth(date);
    ...
    public ConstructorAnimals (Animals animal, String type) {
