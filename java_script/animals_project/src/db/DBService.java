...
import Model.ConstructorAnimals;
...
public class DBService {
    ...
    public void insertAnimal(ConstructorAnimals animalDto) throws SQLException, ClassNotFoundException {
    ...
    public ConstructorAnimals getAnimal(int id) throws SQLException, ClassNotFoundException {
        ...
        try (Connection connection = this.connect;
            ...
            ConstructorAnimals animal = null;
            while (resultSet.next()){
                animal = new ConstructorAnimals(resultSet.getInt("animal_id"),
    ...
    public void newCommand(int id, String command) throws SQLException, ClassNotFoundException {
        ConstructorAnimals animal = getAnimal(id);
